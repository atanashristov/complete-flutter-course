...
import 'package:tony_ecommerce_app/src/features/authentication/presentation/sign_in/email_password_sign_in_controller.dart';
import 'package:tony_ecommerce_app/src/features/authentication/presentation/sign_in/email_password_sign_in_state.dart';
import 'package:tony_ecommerce_app/src/features/authentication/presentation/sign_in/string_validators.dart';
import 'package:tony_ecommerce_app/src/localization/string_hardcoded.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:tony_ecommerce_app/src/common_widgets/custom_text_button.dart';
import 'package:tony_ecommerce_app/src/common_widgets/primary_button.dart';
import 'package:tony_ecommerce_app/src/common_widgets/responsive_scrollable_card.dart';
...
class _EmailPasswordSignInContentsState extends ConsumerState<EmailPasswordSignInContents> {
  ...
  @override
  Widget build(BuildContext context) {
    // Only listen to only the value changes in EmailPasswordSignInScreen.build(),
    // or if not, make changes in EmailPasswordSignInController.updateFormType()
    // to reset the value and thereof clear the error upon form type change.
    //
    // ref.listen<EmailPasswordSignInState>(emailPasswordSignInControllerProvider(widget.formType),
