...
If you're just getting started with the course, you may run into issues when running the starter project.

These are often compile errors related to the **gradle** and **cocoapods** configuration.

To find answers, head over to the FAQ in the sidebar.
